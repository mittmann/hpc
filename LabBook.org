...
And finnaly, let's run the script
...
<<<<<<< HEAD
* 2016-08-10 Note on how to install clang with openmp
...
#+begin_src R :results output :session :exports both :tangle MM_Scenario.r
  ...
  export.design(MM_Scenario,
                ...
                type="csv",
                replace=TRUE,
                response.names=c("time","compiler"));
#+end_src
...
done < MM_Scenario.csv > MM_output.csv
...
#+end_src
>>>>>>> 90e6066442f59970e523c5e4024ea866e6ce8396
