...
http://mpitutorial.com/tutorials/mpi-hello-world/ will be used.

First I need to clone the repository containing the files used in this
tutorial.

#+begin_src sh :results output :exports both
git clone https://github.com/wesleykendall/mpitutorial ../mpitutorial
#+end_src
