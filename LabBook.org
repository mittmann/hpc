...
#+begin_src sh :results output :exports both
otf22paje data/mpi_pingpong/traces.otf2 > data/mpi_pingpong/traces.paje
#+end_src
...
pj_dump traces.paje > traces_rep.csv
#+end_src
...
#+RESULTS:
: PajeDecodeException: Event with id '-1342816216' has not been defined in (Line: 5, Fields: 4, Contents: '-1342816216 machine 0 machine')
