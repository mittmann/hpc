...
$HOME/Programs/akypuera/src/otf2-omp-print/otf2ompprint2paje.pl traces.otf2 > traces.paje
#+end_src
...
#+begin_src sh :results output :exports both :dir data/mpi_pingpong
pj_dump --user-defined --no-imbrication traces.paje > traces.csv
#+end_src
...
#+RESULTS:
: PajeContainerException: Unknown container '1' in (Line: 48, Fields: '9, Contents: '12 0 1 S main 1875 239 8000 0')
