...
** DoE
#+begin_src R :results output :session :exports both :tangle MM_Scenario_5.r
  require(DoE.base);
...
#+begin_src bash :results output :session :exports both :tangle scripts/test_mmv1_5.sh :dir /ssh:arthur.krause@143.54.12.87:~/mm5
#!/bin/bash
...
** DoE
#+begin_src R :results output :session *mm6* :tangle MM_Scenario_6.r
...
#+begin_src bash :results output :session :exports both :tangle scripts/test_mmv1_6.sh :dir /ssh:arthur.krause@143.54.12.87:~/mm6
#!/bin/bash
for i in `seq 0 3`
do
