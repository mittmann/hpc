...
#+begin_src bash :results output :session :exports both
scp MM_Scenario_3.csv aulapinroot@143.54.12.87:~/arthur/exp
scp mmv1.c aulapinroot@143.54.12.87:~/arthur/exp
#+end_src
...
Now the test itself
 ...
 #+begin_src bash :results output :session :exports both :tangle scripts/test_mmv1_3.sh :dir /ssh:aulapinroot@143.54.12.87:~/arthur/exp
#!/bin/bash
for i in `seq 0 3`
do
...
rm -rf mmv1_gcc_*
rm -rf mmv1_clang_*
#send the results to my local machine
scp ../data/MM_output_3.csv arthur@krause:~hpc/data
